          ...
          <h3>Careers</h3>
            <div class="post">
                ...
                <ul>
                  ...
                  <li>Perform welding, fabrication, and other metalworking tasks as needed</li>
                  <li>Maintain accurate records of all work performed</li>
                </ul>
                <h4>Requirements:</h4>
                <ul>
                  <li>Vocational or technical training in agricultural mechanics or a related field</li>
              ...
              <div class="post">
                ...
                <ul>
                  ...
                  <li>Learn about the principles of agricultural mechanics and how to apply them in the field</li>
                  <li>Participate in on-the-job training and attend industry-specific workshops and seminars</li>
                </ul>
                <h4>Requirements:</h4>
                <ul>
                  <li>Currently enrolled in a vocational or technical training program in agricultural mechanics or a related field</li>
                  <li>Strong mechanical aptitude and problem-solving skills</li>
                  <li>Ability to work independently and as part of a team</li>
              ...
              <div class="post">
                ...
                <ul>
                  ...
                  <li>Prepare and deliver sales presentations and proposals to potential clients</li>
                  <li>Maintain accurate records of sales activity and report regularly to management</li>
